        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-5xl md:text-6xl font-bold mb-4">
                ...
                <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
                  {displayText.includes("I'm") ? "I'm Preetha" : ""}
                </span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                ...
                download
                className="group relative px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full text-white font-semibold overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25"
              >
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="relative">
              <div className="w-64 h-64 rounded-full flex items-center justify-center text-white text-8xl font-bold shadow-2xl">
                <img src="/image_a.png" alt="Profile" className="rounded-full" />
              </div>
            ...
            <div className="grid grid-cols-2 gap-6 mt-12">
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">4+</div>
